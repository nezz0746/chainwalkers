...
const config = createConfig(
  getDefaultConfig({
    ...
    transports: {
      ...
      [mainnet.id]: http(
        `https://eth-mainnet.g.alchemy.com/v2/YHL3ekUe1dsk14EoHTpiF`
      ),
      [base.id]: http(
        `https://base-mainnet.g.alchemy.com/v2/YHL3ekUe1dsk14EoHTpiF`
      ),
      [optimism.id]: http(
        `https://opt-mainnet.g.alchemy.com/v2/YHL3ekUe1dsk14EoHTpiF`
      ),
    },
